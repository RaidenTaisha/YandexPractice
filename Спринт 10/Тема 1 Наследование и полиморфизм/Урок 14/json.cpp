...
const Array& Node::AsArray() const {
  return IsArray() ? std::get<Array>(data_) : throw std::logic_error("Is not Array");
}

const Dict& Node::AsMap() const {
  return IsMap() ? std::get<Dict>(data_) : throw std::logic_error("Is not Dict");
}

bool Node::AsBool() const {
  return IsBool() ? std::get<bool>(data_) : throw std::logic_error("Is not bool");
}

int Node::AsInt() const {
  return IsInt() ? std::get<int>(data_) : throw std::logic_error("Is not int");
}

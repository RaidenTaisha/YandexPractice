...
const Array& Node::AsArray() const {
  return IsArray() ? std::get<Array>(*this) : throw std::logic_error("Is not Array");
}

const Dict& Node::AsMap() const {
  return IsMap() ? std::get<Dict>(*this) : throw std::logic_error("Is not Dict");
}

bool Node::AsBool() const {
  return IsBool() ? std::get<bool>(*this) : throw std::logic_error("Is not bool");
}

int Node::AsInt() const {
  return IsInt() ? std::get<int>(*this) : throw std::logic_error("Is not int");
}
...
const std::string& Node::AsString() const {
  return IsString() ? std::get<std::string>(*this) : throw std::logic_error("Is not string");
}

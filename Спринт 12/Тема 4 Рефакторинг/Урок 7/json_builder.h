...
// Я не заморачивался над оформлением коммитов так как дедлайн близко. Просто скопипастил
// авторские решения в конце каждого из уроков и завел новую ветку. Потом я планирую внести
// все изменения в ветку master в их хронологическом порядке и описать коммиты.
namespace json {

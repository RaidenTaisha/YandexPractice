...
inline std::pair<std::string_view, std::optional<std::string_view>> SplitFirst(
...
class Query {
 public:
  ...
  virtual void ProcessAndPrint(BudgetManager &budget,
...
class ComputeQuery : public Query {
 public:
  ...
  void ProcessAndPrint(BudgetManager &budget,
